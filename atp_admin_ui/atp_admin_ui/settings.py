"""
Django settings for atp_admin_ui project.
...
SECRET_KEY = 'django-insecure-94()(u8wm-^n&7bvg^o1)*rr52d(+nhyx9nazm=qc**uibb1td'
...
WSGI_APPLICATION = 'atp_admin_ui.wsgi.application'
